...
export START_TOKEN=$1
export END_TOKEN=$2
export MODEL_NAME=tinyllama'_'$MODEL_SIZE'M_random'$START_TOKEN'_'$END_TOKEN
...
lightning run model \
    ...
    --train_data_dir datasets/lit_dataset_regmix_random$START_TOKEN'_'$END_TOKEN \
    --val_data_dir datasets/lit_dataset_regmix_random$START_TOKEN'_'$END_TOKEN \
    --data_yaml_file configs/tinyllama_$MODEL_SIZE.yaml \
    --out_name $MODEL_NAME \
    --resume True \
