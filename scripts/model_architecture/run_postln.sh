...
export MODEL_NAME=tinyllama'_'$MODEL_SIZE'M_postln'
...
python pretrain/eval_sink_pretrain.py --model_name tinyllama_$MODEL_SIZE --mode postln --load_from checkpoints/$MODEL_NAME/iter-020000-ckpt.pth