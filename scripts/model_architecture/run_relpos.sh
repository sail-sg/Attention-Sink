...
export POS=$1
export MODEL_NAME=tinyllama'_'$MODEL_SIZE'M_relpos_'$POS
...
python pretrain/eval_sink_pretrain.py --model_name tinyllama_$MODEL_SIZE'_'$POS --mode relpos --load_from checkpoints/$MODEL_NAME/iter-020000-ckpt.pth