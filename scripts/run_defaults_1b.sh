...
export MODEL_NAME=tinyllama'_'$MODEL_SIZE'_sigmoid'
...
python pretrain/eval_sink_pretrain.py --model_name tinyllama_1_1b --mode base --load_from checkpoints/$MODEL_NAME/iter-040000-ckpt.pth