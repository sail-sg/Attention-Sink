...
python prepare_file_domain.py --source_path sail/regmix-data-sample --tokenizer_path tokenizer/gptneox --destination_path ../datasets/lit_dataset_regmix --short_name $DATASET_SHORT_NAME --split train
...
python prepare_file_domain.py --source_path sail/regmix-data-sample --tokenizer_path tokenizer/gptneox --destination_path ../datasets/lit_dataset_regmix --short_name $DATASET_SHORT_NAME --split valid --chunk_size 131136
