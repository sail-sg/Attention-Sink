...
class CausalSelfAttention(nn.Module):
    ...
    def forward(
        ...
        y = self.scaled_dot_product_attention(q, k, v, kernel=self.kernel, attention_normalize=self.attention_normalize, attention_bias=attention_bias,)  # (B, H, T, C) 
    ...
    def scaled_dot_product_attention(
        self, q: torch.Tensor, k: torch.Tensor, v: torch.Tensor, kernel: str = 'elu', attention_normalize: bool = True, attention_bias: Optional[torch.Tensor] = None, 
    ):
